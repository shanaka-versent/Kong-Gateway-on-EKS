#!/bin/bash
# EKS Kong Gateway POC - Generate JWT Token for Demo Testing
# @author Shanaka Jayasundera - shanakaj@gmail.com
#
# Generates an HS256 JWT token that authenticates against the demo-user
# KongConsumer credential defined in k8s/apps/api/jwt-auth.yaml.
#
# Usage:
...
# Configuration - must match k8s/apps/api/jwt-auth.yaml Secret values
JWT_ISS="demo-issuer"
...
echo "=== Usage ==="
echo ""
echo "curl -H \"Authorization: Bearer ${TOKEN}\" \${CF_URL}/api/users"
